...
public final class CustomPlayerPortalCreateEvent extends Event implements Cancellable {
    ...
    public CustomPlayerPortalCreateEvent(Player player, CustomPortal portal) {
        this.player = player;
        this.portal = portal;
    }
